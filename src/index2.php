...
<body>
    ...
    <form action="/" method="post" class="page_change">
        <button id="page_back" class="page_back" onclick="page_back()"></button>
        <p><span id="year"><?php echo $year; ?></span>年 <textarea name="set_date" class="set_date" id="month"><?php echo $month; ?></textarea>月</p>
...
<?php
if(isset($day) && isset($lang) && isset($content) && isset($time)){
    $sample = $db->prepare(
        'INSERT INTO 
        `study_data` (
            `study_date`,
